...
1. Read the [Homogeneous response](https://python-at-risoe.pages.windenergy.dtu.dk/codecamp/turbie/5-homogeneous-response.html) page in this folder, ignoring exercise.
1. Read the [Forced response and save to file](https://python-at-risoe.pages.windenergy.dtu.dk/codecamp/turbie/6-forced-response.html)
   page in this folder, ignoring exercise.
